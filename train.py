...
from models.model import TILNet
...
if __name__ == '__main__':
    ...
    parser.add_argument('--file_root', default="BCDD", help='Data directory | LEVIR | BCDD | SYSU ')
